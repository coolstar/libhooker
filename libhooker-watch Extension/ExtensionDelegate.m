//
//  ExtensionDelegate.m
//  libhooker-watch Extension
//
//  Created by CoolStar on 3/2/20.
...
static void (*origObjcFunction)(ExtensionDelegate *, SEL);

static void testObjcReplacement(ExtensionDelegate *self, SEL _cmd){
...
void testObjcHook(void){
    LBHookMessage([ExtensionDelegate class], @selector(applicationDidBecomeActive), (IMP)&testObjcReplacement, (IMP *)&origObjcFunction);
}
